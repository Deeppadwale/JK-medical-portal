          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                  ...
                  <div key={index} className="flex gap-3 items-center">
                    <div className="relative flex-1">
                      <input
                        ...
                        className={`w-full border-2 rounded-xl p-3 pl-12 focus:outline-none focus:ring-2 transition-all duration-200 ${
            ...
            <div className="relative group">
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                ...
                Password {!editId && <span className="text-red-500 ml-1">*</span>}
              </label>
              <div className="relative">
                <input
                  name="User_Password"
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-xs text-gray-500">
                  {editId ? "Keep blank to use existing password" : "Minimum 6 characters"}
                </p>
